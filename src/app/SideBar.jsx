...
const SideBar = ({sideappDetails,header="RECENTLY UPDATED APPS" ,isLoading}) => {
  return (
    ...
    {isLoading ? <LoadingComponent length={5} md={1}/>: <div className="grid sm:grid-cols-2 lg:grid-cols-1">
      {sideappDetails?.map((appDetails) => (
        ...
        >
          <div className=" grid grid-cols-4 lg:grid-cols-3 xl:grid-cols-4">
            ...
            />
            {header==="RECENTLY UPDATED APPS"?<div className="ml-2 col-span-2 ">
              <h4 className="text-sm font-medium truncate">{appDetails.title}</h4>
            ...
            </div> : <div className="ml-2 col-span-2 ">
              <h4 className="text-sm font-medium truncate">{appDetails.title}</h4>
